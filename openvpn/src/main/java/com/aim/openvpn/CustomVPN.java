...
public class CustomVPN implements VpnStatus.ByteCountListener, VpnStatus.StateListener {
    ...
    public CustomVPN(Activity activity, Context context) {
        ...
        if (!App.isStart) {
            ...
            profileAsync = new ProfileAsync(context, new ProfileAsync.OnProfileLoadListener() {
                ...
                public void onProfileLoadFailed(String msg) {
                    Toast.makeText(context, activity.getString(com.aim.openvpn.R.string.init_fail) + msg, Toast.LENGTH_SHORT).show();
                }
            }, url);
