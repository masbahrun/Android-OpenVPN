...
import com.aim.openvpn.BuildConfig;
import com.aim.openvpn.CustomVPN;
import com.aim.openvpn.R;
...
//import com.aim.openvpn.StartVPN;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    private static final String RESUME_VPN = "com.aim.openvpn.RESUME_VPN";
    ...
    private void showNotification(final String msg, String tickerText, @NonNull String channel, long when, ConnectionStatus status) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
           ...
           // Log.e("Notification", "show");
            ...
            String NOTIFICATION_CHANNEL_ID = "com.aim.openvpn";
...
//            }
    ...
    PendingIntent getGraphPendingIntent() {
        ...
        // TODO : Check Later
       // CustomVPN oboloiVPN = new CustomVPN();
        Class activityClass = CustomVPN.class;
